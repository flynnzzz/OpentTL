...
public class TierListTest {
  ...
  public void tier() {
    ...
    // after tiering an item its status should be changed to 'TIERED'
  ...
  public void addTier() {
    ...
    tierList.addTier(t1);
    assertEquals(List.of(t1, t2, t3, t4, t1), tierList.getTiered());
    tierList.addTier(t2);
    assertEquals(List.of(t1, t2, t3, t4, t1, t2), tierList.getTiered());
  ...
  public void removeTierPointer() {
    ...
    assertEquals(List.of(t1, t2, t3), tierList.getTiered());

    tierList.removeTier(t2);
    assertEquals(List.of(t1, t3), tierList.getTiered());

    tierList.removeTier(t3);
    assertEquals(List.of(t1), tierList.getTiered());
  ...
  public void swapTiersPointer() {
    ...
    assertEquals(List.of(t2, t1, t3, t4), tierList.getTiered());

    tierList.swapTiers(t4, t2);
    assertEquals(List.of(t4, t1, t3, t2), tierList.getTiered());
  ...
  public void moveTierPointer() {
    ...
    assertEquals(List.of(t2, t3, t4, t1), tierList.getTiered());

    tierList.moveTier(t4, t3);
    assertEquals(List.of(t2, t4, t3, t1), tierList.getTiered());

    tierList.moveTier(t1, t2);
    assertEquals(List.of(t1, t2, t4, t3), tierList.getTiered());
  ...
  public void getTiers() {
    ...
    List<Tier> tiers = tierList.getTiered();
